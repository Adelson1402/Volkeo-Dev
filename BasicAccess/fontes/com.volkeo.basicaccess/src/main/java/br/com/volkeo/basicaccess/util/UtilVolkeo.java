package br.com.volkeo.basicaccess.util;

import java.util.InputMismatchException;

public class UtilVolkeo {
	...
	public static int verificaTipoDocumento(String documento) {
      String documentoSemFormatacao = removeCaracteresEspeciais(documento);
      int retorno;
